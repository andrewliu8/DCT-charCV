...
#cv2.rectangle(img,(2800,1800),(2880,2050),(0,255,0),2)
...
# rotated_image = cv2.warpAffine(src=thresh1, M=rotate_matrix, dsize=(width, height))
...
rect_kernel = cv2.getStructuringElement(cv2.MORPH_RECT, (10,4))
